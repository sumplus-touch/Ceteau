...
async function request(path: string, options?: RequestInit) {
  ...
  // Tolerant body parsing — DELETE endpoints often return 204 No Content
  // or an empty body, and calling res.json() on that throws SyntaxError
  // which then gets caught silently elsewhere and looks like a successful
  // call. Guard against this: read text first, then try to parse.
