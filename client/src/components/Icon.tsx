// Shared inline-SVG icon component. Originally defined in Layout.tsx;
// extracted here when Layout.tsx was removed in Phase 2 so other pages
// (ChatPage, ProjectsPage) that still use these icons keep working.
//
// New code should reach for lucide-react icons instead — this set is
// preserved for backward compatibility, not for new features.
